...
/** add new_sem */
asmlinkage long sys_mysleep();
asmlinkage long sys_mywakeup();
asmlinkage long sys_sem_initialize(int nb);
asmlinkage long sys_sem_destroy(int sid);
asmlinkage long sys_sem_acquire(int id);
asmlinkage long sys_sem_release(int id);
